...
/**
 * This component loads the user data when the user logged in and
 * displays a loading screen in between.
 */
class Login extends React.Component {
  ...
  /**
   * Loads the user data on mount using the received tokens
   */
  componentDidMount() {
